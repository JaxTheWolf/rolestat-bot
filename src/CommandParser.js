...
class Parser extends EventEmitter {
  ...
  constructor (client, prefix) {
     ...
     * @param {Array} cmd.aliases - The aliases of a command
     * @param {string} cmd.desc - The description that will be shown with the help command
     * @param {string} cmd.help - The help message. E.g.: "say message"
     ...
     * @param {Array|string} type - An array containing types or a string
     * @return {Parser}
     */
    this.addType = type => {
      ...
      if (typeof typename !== `string` || !type) {
        console.log(`[CMDPARSER] Could not set new type: Invalid argument!`)
      } else {
